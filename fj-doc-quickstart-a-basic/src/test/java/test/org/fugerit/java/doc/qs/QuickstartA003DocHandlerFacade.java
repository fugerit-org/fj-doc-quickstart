...
/**
 * file: QuickstartA003DocHandlerFacade.java
 ...
 *
 */
public class QuickstartA003DocHandlerFacade extends TestBase {
	 ...
	 */
	public static final String PATH_STATIC_DATA_TABLE = "cl://sample-doc-xml/QuickstartA003/static-data-table.xml";
	...
	private void generateDoc( String type, String fileName ) {
		...
		try ( Reader reader = this.loadFromClassLoader( PATH_STATIC_DATA_TABLE );
			...
			DocHandlerFactory factory = DocHandlerFactory.newInstance( "cl://doc-facade/doc-handler-quickstart.xml" );
			DocHandlerFacade facade = factory.get( "quickstart-default" );
