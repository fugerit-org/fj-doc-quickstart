...
/**
 * file: QuickstartB003EmbedBase64Image.java
 * version : 001 (2021-02-24)
 * 
 * It is possible to embed images in base64 format.
 * 
 * Goal : 	this example will show how to embed an image in a dynamic doc pipeline.
 * 			
 * 
 * Maven dependancies : 
 ...
 *
 */
public class QuickstartB003EmbedBase64Image extends TestBase {

	/**
	 * Name of the chain configured in out DocProcessConfig
	 */
	public static final String CHAIN_ID = "base64-image";
	...
	private void generateDoc( String type, String fileName ) {
		...
		try ( FileOutputStream dest = new FileOutputStream( destFile ) ) {
			...
			DocProcessContext context = DocProcessContext.newContext( "imgDynamicPipelineBase64" , imgDynamicPipelineBase64 );
